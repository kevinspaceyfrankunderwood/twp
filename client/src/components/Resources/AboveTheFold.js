...
export const AboveTheFold = () => {
  return(
    ...
    >
      ...
      >
        Welcome to the Resouces page!<br/><br/>
      </TWPHeader>
      <TWPSectionHeader
        tabletFontSize={TWPStyleGuide.font.size.small}
      >
      From here, you can learn all about Minnesota's native pollinators and discover new plant species to attract them in your own backyard!
      </TWPSectionHeader>
    </TopWrap>
  );
}
