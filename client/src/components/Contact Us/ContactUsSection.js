...
class ContactUsSection extends React.Component {
  state = {
    formDisplayed: window.location.href === "https://thewildflowerproject.herokuapp.com/" || window.location.href === "https://www.thewildflowerproject.herokuapp.com/" || window.location.href === "http://localhost:3000/submitasite" ? true : false,
